            ...
            {!chatStarted && (
              <div id="intro" className="mt-[16vh] max-w-4xl mx-auto text-center px-4 lg:px-0">
                <h1 className="text-3xl lg:text-6xl font-bold text-bolt-elements-textPrimary mb-4 animate-fade-in">
                  What do you want to <span className="text-purple-600">build</span>?
                </h1>
                <p className="text-md lg:text-xl mb-8 text-bolt-elements-textSecondary animate-fade-in animation-delay-200">
                  Design, generate, and deploy front-end code for clothing e-commerce websites.
                </p>
              </div>
            )}
            <StickToBottom
                ...
                >
                  ...
                  >
                    <textarea
                      ...
                      placeholder="Describe your e-commerce website idea..."
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
